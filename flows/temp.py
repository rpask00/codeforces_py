...
matrix1 = [[sys.maxsize for _ in range(N)]for __ in range(N)]
mins = [sys.maxsize for __ in range(N)]
...
hungarian = Hungarian(matrix1)
print(hungarian.get_results())
# res = max(map(lambda x: matrix1[x[1]][x[0]], hungarian.get_results()))
