...
def calc(expression):
    ...
    for i, s in enumerate(stack):
        if not s.count('$'):
            ...
            single_expression = s[:insert_index-1] + insert_value + s[insert_index+2:]
            stack[i] = solve_expression(split_expression(clear_expression(single_expression)))
